...
const Event = () => {
  ...
  async function bookmark(bookmarkId , eventName, EventDate, EventVenue, EventPoster) {
    console.log("bookmark Id",EventPoster);
    // mark++;
    // if (mark % 2 !== 0) {
    if (!isBookmark) {
      ...
      try {
        ...
        console.log("bookMark successfully do", bookmarkdata.data);
      } catch (e) {
        console.log(e);
      }
    } else {
      try {
        ...
        console.log(
          ...
          deletedBookmark.data
        );
        isBookmark = !isBookmark;
      } 
      
      catch (e) {
        console.error({ message: "there is a error in deletion" });
      }
    }
  }
  return (
            ...
            return (
              ...
              >
                <div className="carddetals">
                  ...
                  <div
                    className="evedetails"
                    style={{ margin: "10px 20px 10px 60px" }}
                  >
                    <div style={{ marginBottom: "6px" }}>
                      <span>Department:</span> {data.Departmen}
                    </div>
                    <div style={{ marginBottom: "6px" }}>
                      <span>Date :</span>
                      {data.Event_date}
                  ...
                  <div className="btn-link">
                    <Button
                      ...
                      color="success"
                      onClick={() =>
                        window.open(data.Resistration_link, "_blank")
                      }
                    >
                      Register
                    </Button>
